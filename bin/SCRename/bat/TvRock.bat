...
REM 環境変数(行末に\は不要)
REM SET SCRPATH=C:\Users\setsulla\Software\dtv\SCRename
REM SET SCRIPTSPATH=C:\Users\setsulla\Software\dtv\SCRename\bat\Scripts
...
REM SCRENAME(Other)
:SCRENAME2
FOR /F "usebackq delims=" %%I in (`CSCRIPT //NoLogo "%SCRPATH%\SCRename.vbs" -f "%~1" "%OUTPUTFOLDER%\$SCtitle$ ($SCyear2$.$SCmonth$.$SCday$ $SCservice$)"`) do set SCRTARGET=%%~I
